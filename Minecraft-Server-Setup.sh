...
wget https://maven.minecraftforge.net/net/minecraftforge/forge/1.19.3-44.0.37/forge-1.19.3-44.0.37-installer.jar
java -jar forge-1.19.3-44.0.30-installer.jar --install
rm forge-1.19.3-44.0.37-installer.jar forge-1.19.3-44.0.37-installer.jar.log
./run.sh
